...
export function MouseSelectOne<T>(list: any[], keyName: string,
  ...
  if (selectedOld.has(Key) && selectedOld.size == 1) return {
...
export function KeyboardSelectOne<T>(list: any[], keyName: string,
                                     selectedOld: Set<T>, focusKey: T, selectKey: T,
                                     Key: T, Ctrl: boolean, Shift: boolean, defaultValue: T): { selectedNew: Set<T>; selectedLast: T; focusLast: T } {
